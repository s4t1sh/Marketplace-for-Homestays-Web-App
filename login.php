    ...
    <div class='container-fluid '>
      <div class='row mt-3 '>
        ...
        <div class='col pt-4 bg-light text-center shadow-sm'>
          ...
          <input type='email' name='loginmail' class='form-control mt-4' placeholder='Email' required>
          <input type='password' name='loginpass' class='form-control mt-3'  placeholder='Password' required>
          <div class='container-fluid'>
            <div class='row'>

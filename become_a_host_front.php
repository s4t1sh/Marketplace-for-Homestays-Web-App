    ...
    <div class="container mt-5 pt-5 pb-5" style="background-color:#f7f7f7;" >
      ...
      <div class="col-1 d-none d-md-block"></div>
        <div class="col">
          ...
          <input type="text" class="form-control" style="border-radius:0px; border: 1px solid black" name="hotel_name" id="hotel_name" value="" placeholder="Enter Hotel/Property name" required>
        </div>
        <div class="col">
          <label for="hotel_country_name" >Country Name</label>
          <input type="text" class="form-control" style="border-radius:0px; border: 1px solid black" name="country_name" id="country_name" value="" placeholder="Enter Country" required>
        </div>
        <div class="col-1 d-none d-md-block"></div>
      </div>
      ...
      <div class="col-1 d-none d-md-block"></div>
        <div class="col">
          ...
          <input type="text" class="form-control" style="border-radius:0px; border: 1px solid black" name="hotel_state_name" id="hotel_state_name" value="" placeholder="Enter State" required>
        </div>
        <div class="col">
        <label for="hotel_city_name" >City Name</label>
          <input type="text" class="form-control" style="border-radius:0px; border: 1px solid black" name="hotel_city_name" id="hotel_city_name" value="" placeholder="Enter City" required>
        </div>
        <div class="col-1 d-none d-md-block"></div>
      </div>
      ...
      <div class="row mt-3">
        ...
        <div class="col">
          ...
          <input type="text" class="form-control" style="border-radius:0px; border: 1px solid black" name="hotel_local_address" id="hotel_local_address" value="" placeholder="Enter Local Address" required>
        </div>
        <div class="col">
          <label for="hotel_price" >Price(INR)</label>
          <input type="number" class="form-control" style="border-radius:0px; border: 1px solid black" name="hotel_price" id="hotel_price" value="" placeholder="Enter price(INR)" required>
        </div>
        <div class="col-1 d-none d-md-block"></div>
      </div>
      ...
      <div class="row mt-3">
        ...
        <div class="col">
          ...
          <input type="number" class="form-control" style="border-radius:0px; border: 1px solid black" name="hotel_guests" id="hotel_guests" value="" placeholder="Enter number of guests allowed" required>
        </div>
        <div class="col">
          <label for="hotel_beds" >Beds</label>
          <input type="number" class="form-control" style="border-radius:0px; border: 1px solid black" name="hotel_beds" id="hotel_beds" value="" placeholder="Enter number of beds" required>
        </div>
        <div class="col-1 d-none d-md-block"></div>
      </div>
      ...
      <div class="row mt-3">
        ...
        <div class="col">
          ...
          <input type="number" class="form-control" style="border-radius:0px; border: 1px solid black" name="hotel_bedroom" id="hotel_bedroom" value="" placeholder="Enter number of bedrooms" required>
        </div>
        <div class="col"></div>
        <div class="col-1 d-none d-md-block"></div>
      </div>
      ...
      <div class="row mt-3">
        ...
        <div class="col">
          ...
          <textarea class="form-control" style="border-radius:0px; border: 1px solid black" name="hotel_description" id="hotel_description" rows="5" value="" placeholder="Description" required></textarea>
        </div>
        <div class="col-1 d-none d-md-block"></div>
      </div>
      ...
      <div class="row mt-5">
        ...
        <div class="col">
          ...
          <input type="file" name="img[]" id="img" multiple style="display:none" required>
        </div>
        <div class="col-1 d-none d-md-block"></div>
      </div>
    </div>
